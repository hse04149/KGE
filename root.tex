...
First of all, we realized the embedding of Fig. \ref{fig:DAG}. The five entities have found their respective embedding points in Fig. \ref{fig:DAGstate}. Entity \(E_1\) retained its initial position as it is the stem node. The remaining four entities selected their positions relative to the anchor point.
...
\begin{figure}[thb]
    ...
    \caption{Embedding of an acyclic graph with 50 nodes.}
