...
Undirected graphs always have one or more spanning trees, and their graph laplacians are symmetry. These features assure only one zero eigenvalue and $ q = 1_N $. 
